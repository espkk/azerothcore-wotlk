...
namespace Acore::Observability
{
    ...
    public:
        ...
        [[nodiscard]] ScopedHistogramTimer MeasureIndexed(std::size_t, StaticStringLiteral, uint32) const
        {
            return {};
        }

        [[nodiscard]] ScopedHistogramTimer MeasureIndexed(std::size_t, StaticStringLiteral, StaticStringLiteral) const
        {
            return {};
        }
    };
