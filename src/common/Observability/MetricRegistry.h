...
namespace Acore::Observability
{
    namespace Detail
    {
        ...
        /// @brief Record @p value into @p series regardless of the runtime enable switch.
        AC_COMMON_API void ObserveHistogramSeries(HistogramSeries& series, double value);
    }
    ...
    public:
        ...
        Detail::GaugeSeries& RegisterInfo(StaticStringLiteral name, StaticStringLiteral help,
            std::vector<Label> labels, std::source_location owner);
        Detail::HistogramSeries& RegisterHistogram(StaticStringLiteral name, StaticStringLiteral help,
    ...
    private:
        ...
        bool IsCompatibleEntry(Entry const& entry, StaticStringLiteral name, StaticStringLiteral help,
    ...
    public:
        ...
        void SetIndexed(std::size_t index, StaticStringLiteral labelName, StaticStringLiteral labelValue,
            double value) const;
        ///@}
