...
if(WITHOUT_METRICS)
  ...
  if(WITH_QUESTDB_METRICS)
    message("")
    message(" *** WITH_QUESTDB_METRICS - WARNING!")
    message(" *** Please note that this will use QuestDB for metrics output")
    add_definitions(-DWITH_QUESTDB_METRICS)
  endif()

  if(WITH_DETAILED_METRICS)
    message("")
