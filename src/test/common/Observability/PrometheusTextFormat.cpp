...
TEST(PrometheusTextFormatTest, FormatsDefaultDurationBucketsInFixedNotation)
{
    MetricRegistry registry;
    registry.RegisterHistogram("op_seconds", "Operation duration",
        DefaultDurationBuckets(), {}, std::source_location::current());

    EXPECT_THAT(PrometheusTextFormat::Serialize(registry), testing::Eq(
        "# HELP op_seconds Operation duration\n"
        "# TYPE op_seconds histogram\n"
        "op_seconds_bucket{le=\"0.0001\"} 0\n"
        "op_seconds_bucket{le=\"0.00025\"} 0\n"
        "op_seconds_bucket{le=\"0.0005\"} 0\n"
        "op_seconds_bucket{le=\"0.001\"} 0\n"
        "op_seconds_bucket{le=\"0.0025\"} 0\n"
        "op_seconds_bucket{le=\"0.005\"} 0\n"
        "op_seconds_bucket{le=\"0.01\"} 0\n"
        "op_seconds_bucket{le=\"0.025\"} 0\n"
        "op_seconds_bucket{le=\"0.05\"} 0\n"
        "op_seconds_bucket{le=\"0.1\"} 0\n"
        "op_seconds_bucket{le=\"0.25\"} 0\n"
        "op_seconds_bucket{le=\"0.5\"} 0\n"
        "op_seconds_bucket{le=\"1\"} 0\n"
        "op_seconds_bucket{le=\"2.5\"} 0\n"
        "op_seconds_bucket{le=\"+Inf\"} 0\n"
        "op_seconds_sum 0\n"
        "op_seconds_count 0\n"));
}
